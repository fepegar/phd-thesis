...
\Acp{ASM} is normally used to treat epilepsy by decreasing the seizure frequency, but do not cure the underlying cause.
In roughly one third of the patients, \acp{ASM} does not adequately control seizures.
