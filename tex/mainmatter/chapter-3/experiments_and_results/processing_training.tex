...
Simulation requires 0.6 to 2.2 s for an image of size $193 \times 229 \times 193$, depending on the addition of white matter lesions and blood products (\sectionref{sec:white,sec:blood}).
...
\input{tex/sections/experiments_and_results/preprocessing_augmentation}