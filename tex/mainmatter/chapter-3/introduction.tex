...
\begin{table}[hb]
  ...
  \caption[Result of querying a database with the term \textit{Head version}]{
    Result of querying a hypothetical database with the semiology terms \textit{Head version}, \textit{Ictal speech}, and \textit{Epigastric aura}, and hypothetical brain structures A, B and C, assuming that the brain has been parcellated into only three structures.
  ...
  \begin{tabular}{lSSS}
    ...
    \textbf{Ictal speech}    &                   52 &                   12 &                    2 \\
    \textbf{Epigastric aura} &                    5 &                    7 &                    0 \\
  \end{tabular}
\end{table}
