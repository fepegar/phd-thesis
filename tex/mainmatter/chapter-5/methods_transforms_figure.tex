\begin{figure}
  ...
  \caption[A selection of data augmentation techniques in TorchIO \torchioversion]{
    ...
    The \ac{MRI} corresponds to the \acf{MNI} Colin 27 average brain \cite{holmes_enhancement_1998}, which can be downloaded using \texttt{torchio.datasets.Colin27}.
