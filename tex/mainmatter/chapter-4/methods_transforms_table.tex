\begin{table}[ht]
    \caption{
        ...
        \protect\logo{nipy}:~NiBabel\citep{brett_nipynibabel_2020};
        \protect\logo{itk}:~SimpleITK\citep{lowekamp_design_2013};
        \protect\logo{numpy}:~NumPy\citep{van_der_walt_numpy_2011};
        \protect\logo{pytorch}:~PyTorch\citep{paszke_pytorch_2019}.
    }
    \footnotesize
    \begin{center}
        \begin{tabular}{c||c|c}
