...
\begin{figure}
  ...
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=\linewidth]{from_slides/gestures-218}
    \caption{\label{fig:gestures_video_1}}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=\linewidth]{from_slides/gestures-219}
  ...
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=\linewidth]{from_slides/gestures-220}
    \caption{\label{fig:gestures_video_3}}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=\linewidth]{from_slides/gestures-221}
  ...
  \caption[Examples of challenging seizure videos in our dataset]{
    ...
    camera out of focus (\subref{fig:gestures_video_1}),
    infrared acquisition (\subref{fig:gestures_video_1}, \subref{fig:gestures_video_2}, \subref{fig:gestures_video_3}),
    low lighting~(\subref{fig:gestures_video_2}),
    compression artifacts (\subref{fig:gestures_video_3}),
    interlacing artifacts (\subref{fig:gestures_video_1}, \subref{fig:gestures_video_2}, \subref{fig:gestures_video_3}, \subref{fig:gestures_video_4}),
    occlusion by bedsheets (\subref{fig:gestures_video_1}, \subref{fig:gestures_video_2}, \subref{fig:gestures_video_3}, \subref{fig:gestures_video_4}),
    and occlusion by nurses (\subref{fig:gestures_video_4}).
  }
  \label{fig:video_challenges}
\end{figure}

% Other works using deep learning
Neural networks can partially overcome these challenges by automatically learning features that are more robust to variations in the data distribution, leveraging large-scale training datasets from similar domains for pre-training.
