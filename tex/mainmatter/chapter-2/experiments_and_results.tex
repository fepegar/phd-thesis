...
\begin{table}
  ...
  \caption[Performance of the feature extractors]{
    ...
    Wide R2D-50-2 is a 50-layer 2D ResNet with a widening factor of 2 \cite{zagoruyko_wide_2017}.
  ...
  \begin{tabular}{@{}l*7c@{}}
    \toprule
    \textbf{Model} & \textbf{\# Frames} & \textbf{Type} & \textbf{\# Params.} & \textbf{Features} & \textbf{Accuracy} & $\bm{F_1}$\textbf{-score}* & \textbf{AUC}* \\
    \midrule
