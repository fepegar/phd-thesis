...
\begin{table}
  ...
  \caption[Performance of the feature extractors]{
    ...
    R(2+1)D-34 is a spatiotemporal (two spatial dimensions and one temporal dimension) ResNet with 34 layers used for video processing; these spatiotemporal models can take 8 or 32 frames as input \cite{ghadiyaram_large-scale_2019}.
  }
  \label{tab:models}
  \scriptsize
